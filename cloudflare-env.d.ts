/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: c18b5863637d873fbb6d46f7aad60fef)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		MEDIA_THUMBNAIL_PREFIX: string;
		MEDIA_THUMBNAIL_RESIZE_OPTS: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "PAYLOAD_SECRET" | "MEDIA_PUBLIC_ORIGIN" | "MEDIA_THUMBNAIL_PREFIX" | "MEDIA_THUMBNAIL_RESIZE_OPTS">> {}
}
